...
pub export fn mmMixerInit(arg_setup: [*c]mm_gba_system) void {
    ...
    _ = __builtin___memset_chk(mm_wavebuffer, @as(c_int, 0), @as(c_ulong, @bitCast(@as(c_ulong, mm_mixlen))) *% @sizeOf(mm_word), __builtin_object_size(mm_wavebuffer, @as(c_int, 0)));
    mp_mix_seg = 0;
    ...
    _ = &mix_ch;
    {
        ...
        while (i < mm_mixch_count) : (i +%= 1) {
            mix_ch[i].src = @as(usize, @bitCast(@as(c_ulong, @as(c_uint, 1) << @intCast((@sizeOf(usize) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))))));
        }
    }
    vblank_handler_enabled = @as(c_int, 1) != 0;
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109024))).* = 0;
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109028))).* = 0;
    @as([*c]volatile u16, @ptrFromInt(@as(c_int, 67108994))).* = 0;
    @as([*c]volatile u16, @ptrFromInt(@as(c_int, 67108994))).* = @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 39436)))));
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109052))).* = @as(mm_word, @intCast(@intFromPtr(mm_wavebuffer)));
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109064))).* = @as(mm_word, @intCast(@intFromPtr(mm_wavebuffer))) +% (mm_mixlen *% @as(mm_word, @bitCast(@as(c_int, 2))));
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109056))).* = @as(mm_word, @intCast(@intFromPtr(@as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109024))))));
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109068))).* = @as(mm_word, @intCast(@intFromPtr(@as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109028))))));
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109060))).* = 3053453312;
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109072))).* = 3053453312;
    @as([*c]volatile u16, @ptrFromInt(@as(c_int, 67108996))).* = 128;
    @as([*c]volatile u32, @ptrFromInt(@as(c_int, 67109120))).* = mm_timerfreq | @as(mm_word, @bitCast(@as(c_int, 128) << @intCast(16)));
}
...
pub export fn mmMixerStopChannel(arg_channel: c_int) void {
    ...
    (blk: {
        const tmp = channel;
        if (tmp >= 0) break :blk mm_mix_channels + @as(usize, @intCast(tmp)) else break :blk mm_mix_channels - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*.src = @as(usize, @bitCast(@as(c_ulong, @as(c_uint, 1) << @intCast((@sizeOf(usize) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))))));
}
...
// src/translate/maxmod/cprep/gba/mixer.c:29:9
pub const ARM_CODE = @compileError("unable to translate C expr: unexpected token ')'");
// src/translate/maxmod/cprep/gba/mixer.c:32:9
pub const IWRAM_CODE = @compileError("unable to translate macro: undefined identifier `long_call`");
// src/translate/maxmod/cprep/gba/mixer.c:33:9
