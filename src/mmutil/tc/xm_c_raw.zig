...
pub export fn Load_XM(arg_mod: [*c]MAS_Module, arg_verbose: @"bool") c_int {
    var mod = arg_mod;
    _ = &mod;
    ...
    _ = &x;
    var xm_version: @"u16" = undefined;
    _ = &xm_version;
    var xm_headsize: @"u32" = undefined;
    _ = &xm_headsize;
    var xm_nchannels: @"u16" = undefined;
    _ = &xm_nchannels;
    var next_sample: @"u8" = undefined;
    _ = &next_sample;
    ...
    mod.*.old_mode = @as(@"bool", @bitCast(@as(i8, @truncate(@as(c_int, 0)))));
    if (((((read32() != @as(@"u32", @bitCast(@as(c_int, 1702131781)))) or (read32() != @as(@"u32", @bitCast(@as(c_int, 1684366446))))) or (read32() != @as(@"u32", @bitCast(@as(c_int, 1685015840))))) or (read32() != @as(@"u32", @bitCast(@as(c_int, 979725429))))) or (@as(c_int, @bitCast(@as(c_uint, read8()))) != @as(c_int, ' '))) return 1;
    {
        x = 0;
    ...
    if (verbose != 0) {
        _ = printf("--------------------------------------------\n");
        _ = printf("Loading XM, \"%s\"\n", @as([*c]u8, @ptrCast(@alignCast(&mod.*.title[@as(usize, @intCast(0))]))));
    }
    if (@as(c_int, @bitCast(@as(c_uint, read8()))) != @as(c_int, 26)) return 1;
    skip8(@as(@"u32", @bitCast(@as(c_int, 20))));
    xm_version = read16();
    xm_headsize = read32();
    mod.*.order_count = @as(@"u16", @bitCast(@as(c_ushort, @as(@"u8", @bitCast(@as(u8, @truncate(read16())))))));
    mod.*.restart_pos = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
    xm_nchannels = read16();
    mod.*.patt_count = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
    mod.*.inst_count = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
    mod.*.freq_mode = @as(@"u8", @bitCast(@as(i8, @truncate(if ((@as(c_int, @bitCast(@as(c_uint, read16()))) & @as(c_int, 1)) != 0) @intFromBool(!false) else @as(c_int, 0)))));
    mod.*.initial_speed = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
    mod.*.initial_tempo = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
    if (verbose != 0) {
        _ = printf("Version....%i.%i\n", (@as(c_int, @bitCast(@as(c_uint, xm_version))) >> @intCast(8)) & @as(c_int, 255), @as(c_int, @bitCast(@as(c_uint, xm_version))) & @as(c_int, 255));
        _ = printf("Length.....%i\n", @as(c_int, @bitCast(@as(c_uint, mod.*.order_count))));
        _ = printf("Restart....%i\n", @as(c_int, @bitCast(@as(c_uint, mod.*.restart_pos))));
        _ = printf("Channels...%i\n", @as(c_int, @bitCast(@as(c_uint, xm_nchannels))));
        _ = printf("#Patterns..%i\n", @as(c_int, @bitCast(@as(c_uint, mod.*.patt_count))));
        _ = printf("#Instr.....%i\n", @as(c_int, @bitCast(@as(c_uint, mod.*.inst_count))));
        _ = printf(@as([*:0]const u8, "Freq Mode..%s\n"), if (@as(c_int, @bitCast(@as(c_uint, mod.*.freq_mode))) != 0) @as([*:0]const u8, "Linear") else @as([*:0]const u8, "Amiga"));
        _ = printf("Speed......%i\n", @as(c_int, @bitCast(@as(c_uint, mod.*.initial_speed))));
        _ = printf("Tempo......%i\n", @as(c_int, @bitCast(@as(c_uint, mod.*.initial_tempo))));
    }
    {
        x = 0;
        while (x < @as(c_int, 32)) : (x += 1) {
            mod.*.channel_volume[@as(c_uint, @intCast(x))] = 64;
            mod.*.channel_panning[@as(c_uint, @intCast(x))] = 128;
        }
    }
    if (verbose != 0) {
        _ = printf("--------------------------------------------\n");
        _ = printf("Reading sequence...\n");
    }
    {
        x = 0;
        while (x < @as(c_int, 200)) : (x += 1) {
            if (x < @as(c_int, @bitCast(@as(c_uint, mod.*.order_count)))) {
                mod.*.orders[@as(c_uint, @intCast(x))] = read8();
            } else {
                _ = read8();
                mod.*.orders[@as(c_uint, @intCast(x))] = 255;
            }
        }
    }
    ...
    _ = file_seek_read(@as(c_int, @bitCast(@as(@"u32", @bitCast(@as(c_int, 60))) +% xm_headsize)), @as(c_int, 0));
    if (verbose != 0) {
        _ = printf("--------------------------------------------\n");
    ...
    mod.*.patterns = @as([*c]Pattern, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, mod.*.patt_count))) *% @sizeOf(Pattern)))));
    {
        ...
        while (x < @as(c_int, @bitCast(@as(c_uint, mod.*.patt_count)))) : (x += 1) {
            if (verbose != 0) {
                _ = printf(" Pattern %2i ", x + @as(c_int, 1));
            }
            _ = Load_XM_Pattern(&(blk: {
                const tmp = x;
                if (tmp >= 0) break :blk mod.*.patterns + @as(usize, @intCast(tmp)) else break :blk mod.*.patterns - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, @as(@"u32", @bitCast(@as(c_uint, xm_nchannels))), verbose);
        }
    }
    mod.*.instruments = @as([*c]Instrument, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, mod.*.inst_count))) *% @sizeOf(Instrument)))));
    mod.*.samples = @as([*c]Sample, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 256)))) *% @sizeOf(Sample)))));
    next_sample = 0;
    if (verbose != 0) {
        _ = printf("--------------------------------------------\n");
        _ = printf("Loading instruments...\n");
        _ = printf(".-----------------------------------------------.\n");
        _ = printf("|INDEX|SAMPLES|ENVELOPE|          NAME          |\n");
        _ = printf("|-----+-------+--------+------------------------|\n");
    }
    {
        x = 0;
        while (x < @as(c_int, @bitCast(@as(c_uint, mod.*.inst_count)))) : (x += 1) {
            if (verbose != 0) {
                _ = printf("|%3i  |", x + @as(c_int, 1));
            }
            _ = Load_XM_Instrument(&(blk: {
                const tmp = x;
...
pub export fn CONV_XM_EFFECT(arg_fx: [*c]@"u8", arg_param: [*c]@"u8") void {
    var fx = arg_fx;
    _ = &fx;
    var param = arg_param;
    _ = &param;
    var wfx: c_int = undefined;
    _ = &wfx;
    var wpm: c_int = undefined;
    _ = &wpm;
    wfx = @as(c_int, @bitCast(@as(c_uint, fx.*)));
    wpm = @as(c_int, @bitCast(@as(c_uint, param.*)));
    while (true) {
        switch (wfx) {
            @as(c_int, 0) => {
                if (wpm != @as(c_int, 0)) {
                    wfx = @as(c_int, 'J') - @as(c_int, 64);
                } else {
                    wfx = blk: {
            ...
            @as(c_int, 3) => {
                wfx = @as(c_int, 'G') - @as(c_int, 64);
                break;
            },
            @as(c_int, 4) => {
                wfx = @as(c_int, 'H') - @as(c_int, 64);
                break;
            },
            @as(c_int, 5) => {
                wfx = @as(c_int, 'L') - @as(c_int, 64);
                break;
            },
            @as(c_int, 6) => {
                wfx = @as(c_int, 'K') - @as(c_int, 64);
                break;
            },
            @as(c_int, 7) => {
                wfx = @as(c_int, 'R') - @as(c_int, 64);
                break;
            },
            @as(c_int, 8) => {
                wfx = @as(c_int, 'X') - @as(c_int, 64);
                break;
            },
            @as(c_int, 9) => {
                wfx = @as(c_int, 'O') - @as(c_int, 64);
                break;
            },
            @as(c_int, 10) => {
                wfx = @as(c_int, 'D') - @as(c_int, 64);
                break;
            },
            @as(c_int, 11) => {
                wfx = @as(c_int, 'B') - @as(c_int, 64);
                break;
            },
            @as(c_int, 12) => {
                wfx = 27;
            ...
            @as(c_int, 13) => {
                wfx = @as(c_int, 'C') - @as(c_int, 64);
                wpm = (wpm & @as(c_int, 15)) + ((wpm >> @intCast(4)) * @as(c_int, 10));
                break;
            },
            @as(c_int, 14) => {
                while (true) {
                    switch (wpm >> @intCast(4)) {
                        @as(c_int, 1) => {
                            wfx = @as(c_int, 'F') - @as(c_int, 64);
                            wpm = @as(c_int, 240) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 2) => {
                            wfx = @as(c_int, 'E') - @as(c_int, 64);
                        ...
                        @as(c_int, 3), @as(c_int, 5) => {
                            wfx = 0;
                            wpm = 0;
                            break;
                        },
                        @as(c_int, 4) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 48) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 6) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 176) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 7) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 64) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 8) => {
                            wfx = @as(c_int, 'X') - @as(c_int, 64);
                            wpm = (wpm & @as(c_int, 15)) * @as(c_int, 16);
                            break;
                        },
                        @as(c_int, 9) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 32) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 10) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 0) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 11) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 16) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 12) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 192) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 13) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 208) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 14) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
                            wpm = @as(c_int, 224) | (wpm & @as(c_int, 15));
                            break;
                        },
                        @as(c_int, 15) => {
                            wfx = @as(c_int, 'S') - @as(c_int, 64);
            ...
            @as(c_int, 15) => {
                if (wpm >= @as(c_int, 32)) {
                    wfx = @as(c_int, 'T') - @as(c_int, 64);
                } else {
                    wfx = @as(c_int, 'A') - @as(c_int, 64);
                }
                break;
            },
            @as(c_int, 16) => {
                wfx = @as(c_int, 'V') - @as(c_int, 64);
                wpm = wpm;
                break;
            },
            @as(c_int, 17) => {
                wfx = @as(c_int, 'W') - @as(c_int, 64);
                break;
            },
            @as(c_int, 18), @as(c_int, 19), @as(c_int, 22), @as(c_int, 23), @as(c_int, 24), @as(c_int, 26), @as(c_int, 28), @as(c_int, 30), @as(c_int, 31), @as(c_int, 32), @as(c_int, 34), @as(c_int, 35) => {
                wfx = 0;
                wpm = 0;
                break;
            },
            ...
            @as(c_int, 25) => {
                wfx = @as(c_int, 'P') - @as(c_int, 64);
                break;
            },
            @as(c_int, 27) => {
                wfx = @as(c_int, 'Q') - @as(c_int, 64);
                break;
            },
            @as(c_int, 29) => {
                wfx = 30;
            ...
            @as(c_int, 33) => {
                if ((wpm >> @intCast(4)) == @as(c_int, 1)) {
                    wfx = @as(c_int, 'F') - @as(c_int, 64);
                    wpm = @as(c_int, 224) | (wpm & @as(c_int, 15));
                } else if ((wpm >> @intCast(4)) == @as(c_int, 2)) {
                    wfx = @as(c_int, 'E') - @as(c_int, 64);
                    wpm = @as(c_int, 224) | (wpm & @as(c_int, 15));
                } else {
                    wfx = 0;
    ...
    fx.* = @as(@"u8", @bitCast(@as(i8, @truncate(wfx))));
    param.* = @as(@"u8", @bitCast(@as(i8, @truncate(wpm))));
}
...
pub extern fn printf([*:0]const u8, ...) c_int;
...
pub export fn Get_XM_Frequency(arg_relnote: s8, arg_finetune: s8) c_int {
    var relnote = arg_relnote;
    _ = &relnote;
    var finetune = arg_finetune;
    _ = &finetune;
    var rn: f64 = @as(f64, @floatFromInt(relnote));
    _ = &rn;
    var ft: f64 = @as(f64, @floatFromInt(finetune));
    _ = &ft;
    var middle_c: f64 = undefined;
    _ = &middle_c;
    var freq: f64 = undefined;
    _ = &freq;
    middle_c = @as(f64, @floatCast(8363.0));
    freq = middle_c * pow(2.0, ((1.0 / 12.0) * rn) + ((1.0 / (12.0 * 128.0)) * ft));
    return @as(c_int, @intFromFloat(freq));
}
pub export fn Load_XM_Instrument(arg_inst: [*c]Instrument, arg_mas: [*c]MAS_Module, arg_p_nextsample: [*c]@"u8", arg_verbose: @"bool") c_int {
    var inst = arg_inst;
    _ = &inst;
    var mas = arg_mas;
    _ = &mas;
    var p_nextsample = arg_p_nextsample;
    _ = &p_nextsample;
    var verbose = arg_verbose;
    _ = &verbose;
    var inst_size: c_int = undefined;
    _ = &inst_size;
    var nsamples: c_int = undefined;
    _ = &nsamples;
    var ns: c_int = undefined;
    _ = &ns;
    var samp_headstart: c_int = undefined;
    _ = &samp_headstart;
    var samp_headsize: c_int = undefined;
    _ = &samp_headsize;
    var inst_headstart: c_int = undefined;
    _ = &inst_headstart;
    var sample_old: c_int = undefined;
    _ = &sample_old;
    var x: c_int = undefined;
    _ = &x;
    ...
    var t: @"u32" = undefined;
    _ = &t;
    var vibtype: @"u8" = undefined;
    _ = &vibtype;
    var vibsweep: @"u8" = undefined;
    _ = &vibsweep;
    var vibdepth: @"u8" = undefined;
    _ = &vibdepth;
    var vibrate: @"u8" = undefined;
    _ = &vibrate;
    var finetune: s8 = undefined;
    _ = &finetune;
    var relnote: s8 = undefined;
    _ = &relnote;
    var loopbits: @"u8" = undefined;
    _ = &loopbits;
    var volbits: @"u8" = undefined;
    _ = &volbits;
    var panbits: @"u8" = undefined;
    _ = &panbits;
    var samp: [*c]Sample = undefined;
    _ = &samp;
    ns = @as(c_int, @bitCast(@as(c_uint, p_nextsample.*)));
    ...
    inst_size = @as(c_int, @bitCast(read32()));
    {
        x = 0;
    ...
    _ = read8();
    nsamples = @as(c_int, @bitCast(@as(c_uint, read16())));
    if (nsamples > @as(c_int, 0)) {
        samp_headsize = @as(c_int, @bitCast(read32()));
        {
            x = 0;
            while (x < @as(c_int, 96)) : (x += 1) {
                inst.*.notemap[@as(c_uint, @intCast(x + @as(c_int, 12)))] = @as(@"u16", @bitCast(@as(c_short, @truncate((((@as(c_int, @bitCast(@as(c_uint, read8()))) + ns) + @as(c_int, 1)) * @as(c_int, 256)) | (x + @as(c_int, 12))))));
            }
        }
        {
            x = 0;
            while (x < @as(c_int, 12)) : (x += 1) {
                inst.*.notemap[@as(c_uint, @intCast(x))] = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, inst.*.notemap[@as(c_uint, @intCast(@as(c_int, 12)))]))) & @as(c_int, 65280)) | x))));
            }
        }
        {
            x = 96;
        ...
        }
        {
            x = 0;
            while (x < @as(c_int, 12)) : (x += 1) {
                inst.*.envelope_volume.node_x[@as(c_uint, @intCast(x))] = read16();
                inst.*.envelope_volume.node_y[@as(c_uint, @intCast(x))] = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
            }
        }
        {
            x = 0;
            while (x < @as(c_int, 12)) : (x += 1) {
                inst.*.envelope_pan.node_x[@as(c_uint, @intCast(x))] = read16();
                inst.*.envelope_pan.node_y[@as(c_uint, @intCast(x))] = @as(@"u8", @bitCast(@as(u8, @truncate(read16()))));
            }
        }
        inst.*.global_volume = 128;
        inst.*.envelope_volume.node_count = read8();
        inst.*.envelope_pan.node_count = read8();
        inst.*.envelope_volume.sus_start = blk: {
            const tmp = read8();
            inst.*.envelope_volume.sus_end = tmp;
            break :blk tmp;
        };
        inst.*.envelope_volume.loop_start = read8();
        inst.*.envelope_volume.loop_end = read8();
        inst.*.envelope_pan.sus_start = blk: {
            const tmp = read8();
            inst.*.envelope_pan.sus_end = tmp;
            break :blk tmp;
        };
        ...
        panbits = read8();
        inst.*.env_flags = 0;
        if ((@as(c_int, @bitCast(@as(c_uint, volbits))) & @as(c_int, 1)) != 0) {
            inst.*.env_flags |= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 1) | @as(c_int, 8)))));
        }
        if ((@as(c_int, @bitCast(@as(c_uint, panbits))) & @as(c_int, 1)) != 0) {
            inst.*.env_flags |= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 2)))));
        }
        if (!((@as(c_int, @bitCast(@as(c_uint, volbits))) & @as(c_int, 2)) != 0)) {
            inst.*.envelope_volume.sus_start = blk: {
        ...
        if (!((@as(c_int, @bitCast(@as(c_uint, panbits))) & @as(c_int, 2)) != 0)) {
            inst.*.envelope_pan.sus_start = blk: {
                const tmp = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 255)))));
                inst.*.envelope_pan.sus_end = tmp;
                break :blk tmp;
        ...
        if (!((@as(c_int, @bitCast(@as(c_uint, volbits))) & @as(c_int, 4)) != 0)) {
            inst.*.envelope_volume.loop_start = blk: {
                const tmp = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 255)))));
                inst.*.envelope_volume.loop_end = tmp;
                break :blk tmp;
            };
        }
        if (!((@as(c_int, @bitCast(@as(c_uint, panbits))) & @as(c_int, 4)) != 0)) {
            inst.*.envelope_pan.loop_start = blk: {
                const tmp = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 255)))));
                inst.*.envelope_pan.loop_end = tmp;
                break :blk tmp;
            };
        }
        vibtype = read8();
        vibsweep = @as(@"u8", @bitCast(@as(i8, @truncate(@divTrunc(@as(c_int, 32768), @as(c_int, @bitCast(@as(c_uint, read8()))) + @as(c_int, 1))))));
        vibdepth = read8();
        vibrate = read8();
        inst.*.fadeout = @as(@"u16", @bitCast(@as(c_short, @truncate(@divTrunc(@as(c_int, @bitCast(@as(c_uint, read16()))), @as(c_int, 32))))));
        _ = file_seek_read(inst_headstart + inst_size, @as(c_int, 0));
        {
            x = 0;
            while (x < nsamples) : (x += 1) {
                if ((ns + x) >= @as(c_int, 256)) return 9;
                samp_headstart = file_tell_read();
                samp = &(blk: {
                    const tmp = ns + x;
                    if (tmp >= 0) break :blk mas.*.samples + @as(usize, @intCast(tmp)) else break :blk mas.*.samples - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                ...
                finetune = @as(s8, @bitCast(read8()));
                loopbits = read8();
                samp.*.default_panning = @as(@"u8", @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, read8()))) >> @intCast(1)) | @as(c_int, 128)))));
                relnote = @as(s8, @bitCast(read8()));
                _ = read8();
                {
                    y = 0;
                    while (y < @as(c_int, 22)) : (y += 1) {
                        samp.*.name[@as(c_uint, @intCast(y))] = @as(u8, @bitCast(read8()));
                        if (y < @as(c_int, 12)) {
                            samp.*.filename[@as(c_uint, @intCast(y))] = samp.*.name[@as(c_uint, @intCast(y))];
                        }
                    }
                }
                samp.*.frequency = @as(@"u32", @bitCast(Get_XM_Frequency(relnote, finetune)));
                samp.*.format = @as(@"u8", @bitCast(@as(i8, @truncate(if ((@as(c_int, @bitCast(@as(c_uint, loopbits))) & @as(c_int, 16)) != 0) @as(c_int, 1) else @as(c_int, 0)))));
                if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
                    samp.*.sample_length /= @as(@"u32", @bitCast(@as(c_int, 2)));
                    samp.*.loop_start /= @as(@"u32", @bitCast(@as(c_int, 2)));
                    samp.*.loop_end /= @as(@"u32", @bitCast(@as(c_int, 2)));
                }
                samp.*.loop_type = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, loopbits))) & @as(c_int, 3)))));
                _ = file_seek_read(samp_headstart + samp_headsize, @as(c_int, 0));
            }
        }
        {
            x = 0;
            while (x < nsamples) : (x += 1) {
                ...
                if (samp.*.sample_length == @as(@"u32", @bitCast(@as(c_int, 0)))) continue;
                sample_old = 0;
                if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
                    samp.*.data = @as(?*anyopaque, @ptrCast(@as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, samp.*.sample_length *% @as(@"u32", @bitCast(@as(c_int, 2))))))))))));
                    {
                        ...
                        while (t < samp.*.sample_length) : (t +%= 1) {
                            sample_old = @as(c_int, @bitCast(@as(c_int, @as(s16, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_int, @as(s16, @bitCast(read16()))))) + sample_old)))))));
                            @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[t] = @as(@"u16", @bitCast(@as(c_short, @truncate(sample_old + @as(c_int, 32768)))));
                        }
                    }
                } else {
                    samp.*.data = @as(?*anyopaque, @ptrCast(@as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, samp.*.sample_length)))))))));
                    {
                        t = 0;
                        while (t < samp.*.sample_length) : (t +%= 1) {
                            sample_old = @as(c_int, @bitCast(@as(c_int, @as(s8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_int, @as(s8, @bitCast(read8()))))) + sample_old)))))));
                            @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[t] = @as(@"u8", @bitCast(@as(i8, @truncate(sample_old + @as(c_int, 128)))));
                        }
                    }
                }
                FixSample(samp);
        ...
        p_nextsample.* = @as(@"u8", @bitCast(@as(i8, @truncate(ns + nsamples))));
        if (verbose != 0) {
            _ = printf("  %2i   |   %s%s   | %-22s |\n", nsamples, if ((@as(c_int, @bitCast(@as(c_uint, volbits))) & @as(c_int, 1)) != 0) "V" else "-", if ((@as(c_int, @bitCast(@as(c_uint, panbits))) & @as(c_int, 1)) != 0) "P" else "-", @as([*c]u8, @ptrCast(@alignCast(&inst.*.name[@as(usize, @intCast(0))]))));
        }
    } else {
        _ = file_seek_read(inst_headstart + inst_size, @as(c_int, 0));
        if (verbose != 0) {
            _ = printf("  --   |   --   | %-22s |\n", @as([*c]u8, @ptrCast(@alignCast(&inst.*.name[@as(usize, @intCast(0))]))));
        }
    }
    return 0;
}
pub export fn Load_XM_Pattern(arg_patt: [*c]Pattern, arg_nchannels: @"u32", arg_verbose: @"bool") c_int {
    var patt = arg_patt;
    _ = &patt;
    ...
    var verbose = arg_verbose;
    _ = &verbose;
    var headsize: @"u32" = undefined;
    _ = &headsize;
    var headstart: @"u32" = undefined;
    _ = &headstart;
    var clength: @"u16" = undefined;
    _ = &clength;
    ...
    _ = &param;
    headstart = @as(@"u32", @bitCast(file_tell_read()));
    headsize = read32();
    if (@as(c_int, @bitCast(@as(c_uint, read8()))) != @as(c_int, 0)) return 7;
    ...
    clength = read16();
    if (verbose != 0) {
        _ = printf("- %i rows, %.2f KB\n", @as(c_int, @bitCast(@as(c_uint, patt.*.nrows))), @as(f64, @floatCast(@as(f32, @floatFromInt(clength)) / @as(f32, @floatFromInt(@as(c_int, 1000))))));
    }
    {
        row = 0;
        while (@as(c_int, @bitCast(@as(c_uint, row))) < (@as(c_int, @bitCast(@as(c_uint, patt.*.nrows))) * @as(c_int, 32))) : (row +%= 1) {
            patt.*.data[row].note = 250;
            patt.*.data[row].vol = 0;
        }
    }
    _ = file_seek_read(@as(c_int, @bitCast(headstart +% headsize)), @as(c_int, 0));
    if (@as(c_int, @bitCast(@as(c_uint, clength))) == @as(c_int, 0)) {
        return 0;
    }
    {
        row = 0;
        while (@as(c_int, @bitCast(@as(c_uint, row))) < @as(c_int, @bitCast(@as(c_uint, patt.*.nrows)))) : (row +%= 1) {
            {
                col = 0;
                while (@as(@"u32", @bitCast(@as(c_uint, col))) < nchannels) : (col +%= 1) {
                    e = @as(@"u32", @bitCast((@as(c_int, @bitCast(@as(c_uint, row))) * @as(c_int, 32)) + @as(c_int, @bitCast(@as(c_uint, col)))));
                    b = read8();
                    if ((@as(c_int, @bitCast(@as(c_uint, b))) & @as(c_int, 128)) != 0) {
                        if ((@as(c_int, @bitCast(@as(c_uint, b))) & @as(c_int, 1)) != 0) {
                            patt.*.data[e].note = read8();
                            if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[e].note))) == @as(c_int, 97)) {
                                patt.*.data[e].note = 255;
                            } else {
                                patt.*.data[e].note +%= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 12) - @as(c_int, 1)))));
                            }
                        }
                        if ((@as(c_int, @bitCast(@as(c_uint, b))) & @as(c_int, 2)) != 0) {
                            patt.*.data[e].inst = read8();
                        }
                        if ((@as(c_int, @bitCast(@as(c_uint, b))) & @as(c_int, 4)) != 0) {
                            patt.*.data[e].vol = read8();
                        }
                        if ((@as(c_int, @bitCast(@as(c_uint, b))) & @as(c_int, 8)) != 0) {
                            fx = read8();
                        } else {
                            fx = 0;
                        }
                        if ((@as(c_int, @bitCast(@as(c_uint, b))) & @as(c_int, 16)) != 0) {
                            param = read8();
                        } else {
                            param = 0;
                        }
                        if ((@as(c_int, @bitCast(@as(c_uint, fx))) != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, param))) != @as(c_int, 0))) {
                            CONV_XM_EFFECT(&fx, &param);
                            patt.*.data[e].fx = fx;
...
pub const cho = @as(c_int, 64);
pub const vstr_xm_samp = "  %2i   |   %s%s   | %-22s |\n";
pub const vstr_xm_nosamp = "  --   |   --   | %-22s |\n";
pub const vstr_xm_div = "--------------------------------------------\n";
pub const vstr_xm_patt = " Pattern %2i ";
pub const vstr_xm_samp_top = ".-----------------------------------------------.\n";
pub const vstr_xm_samp_header = "|INDEX|SAMPLES|ENVELOPE|          NAME          |\n";
pub const vstr_xm_samp_prefix = "|%3i  |";
pub const vstr_xm_samp_slice = "|-----+-------+--------+------------------------|\n";
pub const vstr_xm_samp_bottom = "`-----------------------------------------------'\n";
