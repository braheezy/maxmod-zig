...
pub export fn file_size(arg_filename: [*c]u8) c_int {
    ...
    a = @as(c_int, @bitCast(@as(c_int, @truncate(ftell(f)))));
    _ = fclose(f);
    return a;
}
pub export fn file_open_read(arg_filename: [*c]u8) c_int {
    var filename = arg_filename;
    _ = &filename;
    fin = fopen(filename, "rb");
    if (!(fin != null)) return -@as(c_int, 1);
    return 0;
}
pub export fn file_open_write(arg_filename: [*c]u8) c_int {
    var filename = arg_filename;
    _ = &filename;
    fout = fopen(filename, "wb");
    if (!(fout != null)) return -@as(c_int, 1);
    return 0;
}
pub export fn file_open_write_end(arg_filename: [*c]u8) c_int {
    var filename = arg_filename;
    _ = &filename;
    fout = fopen(filename, "r+b");
    if (!(fout != null)) return -@as(c_int, 1);
    _ = fseek(fout, @as(c_long, @bitCast(@as(c_long, @as(c_int, 0)))), @as(c_int, 2));
    return 0;
}
pub export fn file_close_read() void {
    _ = fclose(fin);
}
pub export fn file_close_write() void {
    _ = fclose(fout);
}
pub export fn read8() @"u8" {
    var a: @"u8" = undefined;
    _ = &a;
    _ = fread(@as(?*anyopaque, @ptrCast(&a)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), fin);
    return a;
}
pub export fn read16() @"u16" {
    var a: @"u16" = undefined;
    _ = &a;
    a = @as(@"u16", @bitCast(@as(c_ushort, read8())));
    a |= @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(@"u16", @bitCast(@as(c_ushort, read8())))))) << @intCast(8)))));
    return a;
}
pub export fn read24() @"u32" {
    var a: @"u32" = undefined;
    _ = &a;
    a = @as(@"u32", @bitCast(@as(c_uint, read8())));
    a |= @as(@"u32", @bitCast(@as(c_uint, read8()))) << @intCast(8);
    a |= @as(@"u32", @bitCast(@as(c_uint, read8()))) << @intCast(16);
    return a;
}
pub export fn read32() @"u32" {
    var a: @"u32" = undefined;
    _ = &a;
    a = @as(@"u32", @bitCast(@as(c_uint, read16())));
    a |= @as(@"u32", @bitCast(@as(c_uint, read16()))) << @intCast(16);
    return a;
}
pub export fn write8(arg_p_v: @"u8") void {
    var p_v = arg_p_v;
    _ = &p_v;
    _ = fwrite(@as(?*const anyopaque, @ptrCast(&p_v)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), fout);
    file_byte_count += 1;
}
pub export fn write16(arg_p_v: @"u16") void {
    var p_v = arg_p_v;
    _ = &p_v;
    write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, p_v))) & @as(c_int, 255))))));
    write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, p_v))) >> @intCast(8))))));
    file_byte_count += @as(c_int, 2);
}
pub export fn write24(arg_p_v: @"u32") void {
    var p_v = arg_p_v;
    _ = &p_v;
    write8(@as(@"u8", @bitCast(@as(u8, @truncate(p_v & @as(@"u32", @bitCast(@as(c_int, 255))))))));
    write8(@as(@"u8", @bitCast(@as(u8, @truncate((p_v >> @intCast(8)) & @as(@"u32", @bitCast(@as(c_int, 255))))))));
    write8(@as(@"u8", @bitCast(@as(u8, @truncate((p_v >> @intCast(16)) & @as(@"u32", @bitCast(@as(c_int, 255))))))));
    file_byte_count += @as(c_int, 3);
}
pub export fn write32(arg_p_v: @"u32") void {
    var p_v = arg_p_v;
    _ = &p_v;
    write16(@as(@"u16", @bitCast(@as(c_ushort, @truncate(p_v & @as(@"u32", @bitCast(@as(c_int, 65535))))))));
    write16(@as(@"u16", @bitCast(@as(c_ushort, @truncate(p_v >> @intCast(16))))));
    file_byte_count += @as(c_int, 4);
}
pub export fn align16() void {
    if ((ftell(fout) & @as(c_long, @bitCast(@as(c_long, @as(c_int, 1))))) != 0) {
        write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 186))))));
    }
}
pub export fn align32() void {
    if ((ftell(fout) & @as(c_long, @bitCast(@as(c_long, @as(c_int, 3))))) != 0) {
        write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 186))))));
    }
    if ((ftell(fout) & @as(c_long, @bitCast(@as(c_long, @as(c_int, 3))))) != 0) {
        write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 186))))));
...
pub export fn skip8(arg_count: @"u32") void {
    var count = arg_count;
    _ = &count;
    _ = fseek(fin, @as(c_long, @bitCast(@as(c_ulong, count))), @as(c_int, 1));
}
pub export fn file_seek_read(arg_offset: c_int, arg_mode: c_int) c_int {
    var offset = arg_offset;
    _ = &offset;
    var mode = arg_mode;
    _ = &mode;
    return fseek(fin, @as(c_long, @bitCast(@as(c_long, offset))), mode);
}
pub export fn file_seek_write(arg_offset: c_int, arg_mode: c_int) c_int {
    var offset = arg_offset;
    _ = &offset;
    var mode = arg_mode;
    _ = &mode;
    return fseek(fout, @as(c_long, @bitCast(@as(c_long, offset))), mode);
}
pub export fn file_tell_read() c_int {
    return @as(c_int, @bitCast(@as(c_int, @truncate(ftell(fin)))));
}
pub export fn file_tell_write() c_int {
    return @as(c_int, @bitCast(@as(c_int, @truncate(ftell(fout)))));
}
pub export fn read8f(arg_p_fin: [*c]FILE) @"u8" {
    var p_fin = arg_p_fin;
    _ = &p_fin;
    var a: @"u8" = undefined;
    _ = &a;
    _ = fread(@as(?*anyopaque, @ptrCast(&a)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), p_fin);
    return a;
}
pub export fn read16f(arg_p_fin: [*c]FILE) @"u16" {
    var p_fin = arg_p_fin;
    _ = &p_fin;
    var a: @"u16" = undefined;
    _ = &a;
    a = @as(@"u16", @bitCast(@as(c_ushort, read8f(p_fin))));
    a |= @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(@"u16", @bitCast(@as(c_ushort, read8f(p_fin))))))) << @intCast(8)))));
    return a;
}
pub export fn read32f(arg_p_fin: [*c]FILE) @"u32" {
    var p_fin = arg_p_fin;
    _ = &p_fin;
    var a: @"u32" = undefined;
    _ = &a;
    a = @as(@"u32", @bitCast(@as(c_uint, read16f(p_fin))));
    a |= @as(@"u32", @bitCast(@as(c_uint, read16f(p_fin)))) << @intCast(16);
    return a;
}
pub export fn align32f(arg_p_file: [*c]FILE) void {
    var p_file = arg_p_file;
    _ = &p_file;
    if ((ftell(p_file) & @as(c_long, @bitCast(@as(c_long, @as(c_int, 3))))) != 0) {
        write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 186))))));
    }
    if ((ftell(p_file) & @as(c_long, @bitCast(@as(c_long, @as(c_int, 3))))) != 0) {
        write8(@as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 186))))));
...
pub export fn skip8f(arg_count: @"u32", arg_p_file: [*c]FILE) void {
    var count = arg_count;
    _ = &count;
    var p_file = arg_p_file;
    _ = &p_file;
    _ = fseek(p_file, @as(c_long, @bitCast(@as(c_ulong, count))), @as(c_int, 1));
}
pub export fn file_delete(arg_filename: [*c]u8) void {
    var filename = arg_filename;
    _ = &filename;
...
pub export fn file_exists(arg_filename: [*c]u8) @"bool" {
    var filename = arg_filename;
    _ = &filename;
    fin = fopen(filename, "rb");
    if (!(fin != null)) return @as(@"bool", @bitCast(@as(i8, @truncate(@as(c_int, 0)))));
    file_close_read();
    return @as(@"bool", @intFromBool(!false));
}
pub export fn file_get_byte_count() c_int {
    var a: c_int = file_byte_count;
    _ = &a;
    file_byte_count = 0;
    return a;
}
pub export fn file_tell_size() c_int {
    var pos: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(ftell(fin)))));
    _ = &pos;
    _ = fseek(fin, @as(c_long, @bitCast(@as(c_long, @as(c_int, 0)))), @as(c_int, 2));
    var size: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(ftell(fin)))));
    _ = &size;
    _ = fseek(fin, @as(c_long, @bitCast(@as(c_long, pos))), @as(c_int, 0));
    return size;
}
pub export var fin: [*c]FILE = @import("std").mem.zeroes([*c]FILE);
pub export var fout: [*c]FILE = @import("std").mem.zeroes([*c]FILE);
pub export var file_byte_count: c_int = @import("std").mem.zeroes(c_int);
