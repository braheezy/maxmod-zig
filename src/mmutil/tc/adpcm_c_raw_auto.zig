...
pub export const IndexTable: [8]s8 = [8]s8{
    @as(s8, @bitCast(@as(i8, @truncate(-@as(c_int, 1))))),
    @as(s8, @bitCast(@as(i8, @truncate(-@as(c_int, 1))))),
    @as(s8, @bitCast(@as(i8, @truncate(-@as(c_int, 1))))),
    @as(s8, @bitCast(@as(i8, @truncate(-@as(c_int, 1))))),
    2,
...
pub export const AdpcmTable: [89]@"u16" = [89]@"u16"{
    7,
    8,
    9,
    10,
    ...
    230,
    253,
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 279))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 307))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 337))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 371))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 408))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 449))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 494))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 544))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 598))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 658))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 724))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 796))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 876))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 963))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1060))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1166))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1282))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1411))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1552))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1707))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1878))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 2066))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 2272))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 2499))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 2749))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 3024))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 3327))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 3660))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 4026))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 4428))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 4871))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 5358))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 5894))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 6484))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 7132))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 7845))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 8630))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 9493))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 10442))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 11487))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 12635))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 13899))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 15289))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16818))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 18500))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 20350))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 22385))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 24623))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 27086))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 29794))))),
    @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 32767))))),
};
pub fn read_sample(arg_sample: [*c]Sample, arg_position: c_int) callconv(.c) c_int {
    ...
    _ = &s;
    if ((@as(c_int, @bitCast(@as(c_uint, sample.*.format))) & @as(c_int, 1)) != 0) {
        s = @as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = position;
            if (tmp >= 0) break :blk @as([*c]s16, @ptrCast(@alignCast(sample.*.data))) + @as(usize, @intCast(tmp)) else break :blk @as([*c]s16, @ptrCast(@alignCast(sample.*.data))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*)));
    } else {
        var a: c_int = @as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = position;
            if (tmp >= 0) break :blk @as([*c]s8, @ptrCast(@alignCast(sample.*.data))) + @as(usize, @intCast(tmp)) else break :blk @as([*c]s8, @ptrCast(@alignCast(sample.*.data))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*)));
        _ = &a;
        s = a << @intCast(8);
    }
...
pub fn minmax(arg_value: c_int, arg_low: c_int, arg_high: c_int) callconv(.c) c_int {
    var value = arg_value;
    _ = &value;
    var low = arg_low;
    _ = &low;
...
pub fn calc_delta(arg_diff: c_int, arg_step: c_int) callconv(.c) c_int {
    var diff = arg_diff;
    _ = &diff;
    var step = arg_step;
    _ = &step;
    var delta: c_int = step >> @intCast(3);
    _ = &delta;
    if (diff >= step) {
        diff -= step;
        delta += step;
    }
    if (diff >= (step >> @intCast(1))) {
        diff -= step >> @intCast(1);
        delta += step >> @intCast(1);
    }
    if (diff >= (step >> @intCast(2))) {
        diff -= step >> @intCast(2);
        delta += step >> @intCast(2);
    }
    return delta;
}
pub export fn MM_adpcm_compress_sampleImpl(arg_sample: [*c]Sample) void {
    var sample = arg_sample;
    _ = &sample;
    var x: @"u32" = undefined;
    _ = &x;
    ...
    _ = &output;
    var prev_value: c_int = undefined;
    _ = &prev_value;
    var curr_value: c_int = undefined;
    _ = &curr_value;
    var diff: c_int = undefined;
    _ = &diff;
    var data: c_int = undefined;
    _ = &data;
    ...
    _ = &step;
    output = @as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, (sample.*.sample_length / @as(@"u32", @bitCast(@as(c_int, 2)))) +% @as(@"u32", @bitCast(@as(c_int, 4))))))))));
    prev_value = read_sample(sample, @as(c_int, 0));
    index = 0;
    {
        var i: c_int = undefined;
        _ = &i;
        var smallest_error: c_int = undefined;
        _ = &smallest_error;
        var tmp_error: c_int = undefined;
        _ = &tmp_error;
        smallest_error = 9999999;
        diff = read_sample(sample, @as(c_int, 1)) - read_sample(sample, @as(c_int, 0));
        {
            i = 0;
            while (i < @as(c_int, 88)) : (i += 1) {
    ...
    @as([*c]@"u32", @ptrCast(@alignCast(output))).* = @as(@"u32", @bitCast(prev_value | (index << @intCast(16))));
    step = @as(c_int, @bitCast(@as(c_uint, AdpcmTable[@as(c_uint, @intCast(index))])));
    {
        x = 0;
        while (x < sample.*.sample_length) : (x +%= 1) {
            curr_value = read_sample(sample, @as(c_int, @bitCast(x)));
            ...
            prev_value += if ((data & @as(c_int, 8)) != 0) -delta else delta;
            prev_value = minmax(prev_value, -@as(c_int, 32767), @as(c_int, 32767));
            index = minmax(index + @as(c_int, @bitCast(@as(c_int, IndexTable[@as(c_uint, @intCast(data & @as(c_int, 7)))]))), @as(c_int, 0), @as(c_int, 88));
            step = @as(c_int, @bitCast(@as(c_uint, AdpcmTable[@as(c_uint, @intCast(index))])));
            if ((x & @as(@"u32", @bitCast(@as(c_int, 1)))) != 0) {
                output[(x >> @intCast(1)) +% @as(@"u32", @bitCast(@as(c_int, 4)))] |= @as(@"u8", @bitCast(@as(i8, @truncate(data << @intCast(4)))));
            } else {
                output[(x >> @intCast(1)) +% @as(@"u32", @bitCast(@as(c_int, 4)))] = @as(@"u8", @bitCast(@as(i8, @truncate(data))));
            }
        }
    }
    free(sample.*.data);
    sample.*.data = @as(?*anyopaque, @ptrCast(output));
    sample.*.format = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 4)))));
    sample.*.sample_length = (sample.*.sample_length / @as(@"u32", @bitCast(@as(c_int, 2)))) +% @as(@"u32", @bitCast(@as(c_int, 4)));
    sample.*.loop_start /= @as(@"u32", @bitCast(@as(c_int, 2)));
    sample.*.loop_end /= @as(@"u32", @bitCast(@as(c_int, 2)));
    sample.*.loop_start +%= @as(@"u32", @bitCast(@as(c_int, 4)));
    sample.*.loop_end +%= @as(@"u32", @bitCast(@as(c_int, 4)));
}
...
pub const adpcm_compress_sample = MM_adpcm_compress_sampleImpl;
