...
pub extern fn adpcm_compress_sample(sample: [*c]Sample) void;
pub extern var ignore_sflags: c_int;
pub export fn Sample_PadStart(arg_samp: [*c]Sample, arg_count: @"u32") void {
    var samp = arg_samp;
    _ = &samp;
    var count = arg_count;
    _ = &count;
    var newdata8: [*c]@"u8" = undefined;
    _ = &newdata8;
    var newdata16: [*c]@"u16" = undefined;
    _ = &newdata16;
    var x: @"u32" = undefined;
    _ = &x;
    if (count == @as(@"u32", @bitCast(@as(c_int, 0)))) return;
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
        newdata16 = @as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, (samp.*.sample_length +% count) *% @as(@"u32", @bitCast(@as(c_int, 2))))))))));
        {
            x = 0;
            while (x < count) : (x +%= 1) {
                newdata16[x] = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 32768)))));
            }
        }
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                newdata16[count +% x] = @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[x];
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata16));
    } else {
        newdata8 = @as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, samp.*.sample_length +% count)))))));
        {
            x = 0;
            while (x < count) : (x +%= 1) {
                newdata8[x] = 128;
        ...
        }
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                newdata8[count +% x] = @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[x];
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata8));
    }
    samp.*.loop_start +%= count;
    samp.*.loop_end +%= count;
    samp.*.sample_length +%= count;
}
pub export fn Sample_PadEnd(arg_samp: [*c]Sample, arg_count: @"u32") void {
    var samp = arg_samp;
    _ = &samp;
    var count = arg_count;
    _ = &count;
    ...
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
        newdata16 = @as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, (samp.*.sample_length +% count) *% @as(@"u32", @bitCast(@as(c_int, 2))))))))));
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                newdata16[x] = @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[x];
            }
        }
        {
            x = 0;
            while (x < count) : (x +%= 1) {
                newdata16[samp.*.sample_length +% x] = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 32768)))));
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata16));
        ...
        newdata8 = @as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, samp.*.sample_length +% count)))))));
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                newdata8[x] = @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[x];
            }
        }
        {
            x = 0;
...
pub export fn Unroll_Sample_Loop(arg_samp: [*c]Sample, arg_count: @"u32") void {
    var samp = arg_samp;
    _ = &samp;
    var count = arg_count;
    _ = &count;
    ...
    var newdata16: [*c]@"u16" = undefined;
    _ = &newdata16;
    var newlen: @"u32" = undefined;
    _ = &newlen;
    var looplen: @"u32" = undefined;
    _ = &looplen;
    var x: @"u32" = undefined;
    _ = &x;
    ...
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
        newdata16 = @as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, newlen *% @as(@"u32", @bitCast(@as(c_int, 2))))))))));
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                newdata16[x] = @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[x];
        ...
        {
            x = 0;
            while (x < (looplen *% count)) : (x +%= 1) {
                newdata16[samp.*.sample_length +% x] = @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[samp.*.loop_start +% (x % looplen)];
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata16));
    } else {
        newdata8 = @as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, newlen)))))));
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                newdata8[x] = @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[x];
        ...
        }
        {
            x = 0;
            while (x < (looplen *% count)) : (x +%= 1) {
                newdata8[samp.*.sample_length +% x] = @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[samp.*.loop_start +% (x % looplen)];
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata8));
...
pub export fn Unroll_BIDI_Sample(arg_samp: [*c]Sample) void {
    var samp = arg_samp;
    _ = &samp;
    var newdata8: [*c]@"u8" = undefined;
    _ = &newdata8;
    ...
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
        ...
        }
        {
            x = 0;
            while (x < looplen) : (x +%= 1) {
                newdata16[x +% samp.*.sample_length] = @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[(samp.*.loop_end -% @as(@"u32", @bitCast(@as(c_int, 1)))) -% x];
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata16));
        ...
        }
        {
            x = 0;
            while (x < looplen) : (x +%= 1) {
                newdata8[x +% samp.*.sample_length] = @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[(samp.*.loop_end -% @as(@"u32", @bitCast(@as(c_int, 1)))) -% x];
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata8));
...
pub export fn Resample(arg_samp: [*c]Sample, arg_newsize: @"u32") void {
    var samp = arg_samp;
    _ = &samp;
    ...
    var dst8: [*c]@"u8" = null;
    _ = &dst8;
    var dst16: [*c]@"u16" = null;
    _ = &dst16;
    var src8: [*c]@"u8" = @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)));
    _ = &src8;
    var src16: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)));
    _ = &src16;
    var oldlength: c_int = @as(c_int, @bitCast(samp.*.sample_length));
    _ = &oldlength;
    var lpoint: c_int = @as(c_int, @bitCast(samp.*.loop_start));
    _ = &lpoint;
    var i: c_int = undefined;
    _ = &i;
    var bit16: @"bool" = @as(@"bool", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)))));
    _ = &bit16;
    var sign_diff: f64 = undefined;
    _ = &sign_diff;
    if (bit16 != 0) {
        dst16 = @as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, newsize *% @as(@"u32", @bitCast(@as(c_int, 2))))))))));
        sign_diff = 32768.0;
    } else {
        dst8 = @as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, newsize)))))));
        sign_diff = 128.0;
    }
    var tscale: f64 = @as(f64, @floatFromInt(oldlength)) / @as(f64, @floatFromInt(newsize));
    _ = &tscale;
    var posf: f64 = undefined;
    _ = &posf;
    {
        i = 0;
        while (@as(@"u32", @bitCast(i)) < newsize) : (i += 1) {
            posf = @as(f64, @floatFromInt(i)) * tscale;
            var posi: c_int = @as(c_int, @intFromFloat(floor(posf)));
            _ = &posi;
            var mu: f64 = posf - @as(f64, @floatFromInt(posi));
            _ = &mu;
            ...
            _ = &s2;
            var s3: f64 = undefined;
            _ = &s3;
            var mu2: f64 = undefined;
            _ = &mu2;
            ...
            _ = &a2;
            var a3: f64 = undefined;
            _ = &a3;
            var res: f64 = undefined;
            _ = &res;
            if (bit16 != 0) {
                s0 = if ((posi - @as(c_int, 1)) < @as(c_int, 0)) @as(f64, @floatFromInt(@as(c_int, 0))) else @as(f64, @floatFromInt((blk: {
                    const tmp = posi - @as(c_int, 1);
                    if (tmp >= 0) break :blk src16 + @as(usize, @intCast(tmp)) else break :blk src16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*));
                s1 = @as(f64, @floatFromInt((blk: {
                    const tmp = posi;
                    if (tmp >= 0) break :blk src16 + @as(usize, @intCast(tmp)) else break :blk src16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*));
                s2 = if ((posi + @as(c_int, 1)) >= oldlength) if (@as(c_int, @bitCast(@as(c_uint, samp.*.loop_type))) != 0) @as(f64, @floatFromInt((blk: {
                    const tmp = lpoint + ((posi + @as(c_int, 1)) - oldlength);
                    if (tmp >= 0) break :blk src16 + @as(usize, @intCast(tmp)) else break :blk src16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)) else @as(f64, @floatFromInt(@as(c_int, 0))) else @as(f64, @floatFromInt((blk: {
                    const tmp = posi + @as(c_int, 1);
                    if (tmp >= 0) break :blk src16 + @as(usize, @intCast(tmp)) else break :blk src16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*));
                s3 = if ((posi + @as(c_int, 1)) >= oldlength) if (@as(c_int, @bitCast(@as(c_uint, samp.*.loop_type))) != 0) @as(f64, @floatFromInt((blk: {
                    const tmp = lpoint + ((posi + @as(c_int, 2)) - oldlength);
                    if (tmp >= 0) break :blk src16 + @as(usize, @intCast(tmp)) else break :blk src16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)) else @as(f64, @floatFromInt(@as(c_int, 0))) else @as(f64, @floatFromInt((blk: {
                    const tmp = posi + @as(c_int, 2);
                    if (tmp >= 0) break :blk src16 + @as(usize, @intCast(tmp)) else break :blk src16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*));
            } else {
                s0 = if ((posi - @as(c_int, 1)) < @as(c_int, 0)) @as(f64, @floatFromInt(@as(c_int, 0))) else @as(f64, @floatFromInt((blk: {
                    const tmp = posi - @as(c_int, 1);
                    if (tmp >= 0) break :blk src8 + @as(usize, @intCast(tmp)) else break :blk src8 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*));
                s1 = @as(f64, @floatFromInt((blk: {
                    const tmp = posi;
                    if (tmp >= 0) break :blk src8 + @as(usize, @intCast(tmp)) else break :blk src8 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            ...
            var resi: c_int = @as(c_int, @intFromFloat(floor(res + 0.5)));
            _ = &resi;
            if (bit16 != 0) {
                if (resi < -@as(c_int, 32768)) {
                    resi = -@as(c_int, 32768);
                }
                if (resi > @as(c_int, 32767)) {
                    resi = 32767;
                }
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk dst16 + @as(usize, @intCast(tmp)) else break :blk dst16 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(@"u16", @bitCast(@as(c_short, @truncate(resi + @as(c_int, 32768)))));
            } else {
                if (resi < -@as(c_int, 128)) {
                    resi = -@as(c_int, 128);
                }
                if (resi > @as(c_int, 127)) {
                    resi = 127;
                }
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk dst8 + @as(usize, @intCast(tmp)) else break :blk dst8 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(@"u8", @bitCast(@as(i8, @truncate(resi + @as(c_int, 128)))));
            }
        }
    }
    free(samp.*.data);
    if (bit16 != 0) {
        samp.*.data = @as(?*anyopaque, @ptrCast(dst16));
    } else {
        samp.*.data = @as(?*anyopaque, @ptrCast(dst8));
    }
    samp.*.sample_length = newsize;
    samp.*.loop_end = newsize;
    samp.*.loop_start = @as(@"u32", @bitCast(@as(c_int, @intFromFloat(((@as(f64, @floatFromInt(samp.*.loop_start)) * @as(f64, @floatFromInt(newsize))) + (@as(f64, @floatFromInt(oldlength)) / @as(f64, @floatFromInt(@as(c_int, 2))))) / @as(f64, @floatFromInt(oldlength))))));
    samp.*.frequency = @as(@"u32", @bitCast(@as(c_int, @intFromFloat(((@as(f64, @floatFromInt(samp.*.frequency)) * @as(f64, @floatFromInt(newsize))) + (@as(f64, @floatFromInt(oldlength)) / @as(f64, @floatFromInt(@as(c_int, 2))))) / @as(f64, @floatFromInt(oldlength))))));
}
pub export fn Sample_8bit(arg_samp: [*c]Sample) void {
    var samp = arg_samp;
    _ = &samp;
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
        ...
        var t: @"u32" = undefined;
        _ = &t;
        newdata = @as([*c]@"u8", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, samp.*.sample_length)))))));
        {
            t = 0;
            while (t < samp.*.sample_length) : (t +%= 1) {
                newdata[t] = @as(@"u8", @bitCast(@as(i8, @truncate(@divTrunc(@as(c_int, @bitCast(@as(c_uint, @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[t]))), @as(c_int, 256))))));
            }
        }
        free(samp.*.data);
        samp.*.data = @as(?*anyopaque, @ptrCast(newdata));
        samp.*.format &= @as(@"u8", @bitCast(@as(i8, @truncate(~@as(c_int, 1)))));
    }
}
pub export fn Sample_Sign(arg_samp: [*c]Sample) void {
    var samp = arg_samp;
    _ = &samp;
    var x: @"u32" = undefined;
    _ = &x;
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                var a: c_int = @as(c_int, @bitCast(@as(c_uint, @as([*c]@"u16", @ptrCast(@alignCast(samp.*.data)))[x]))) - @as(c_int, 32768);
                _ = &a;
                if (a < -@as(c_int, 32767)) {
                    a = -@as(c_int, 32767);
                }
    ...
    } else {
        {
            x = 0;
            while (x < samp.*.sample_length) : (x +%= 1) {
                var a: c_int = @as(c_int, @bitCast(@as(c_uint, @as([*c]@"u8", @ptrCast(@alignCast(samp.*.data)))[x]))) - @as(c_int, 128);
                _ = &a;
                if (a == -@as(c_int, 128)) {
                    a = -@as(c_int, 127);
                }
    ...
    samp.*.format |= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 2)))));
}
pub export fn FixSample_GBA(arg_samp: [*c]Sample) void {
    var samp = arg_samp;
    _ = &samp;
    Sample_8bit(samp);
    if (@as(c_int, @bitCast(@as(c_uint, samp.*.loop_type))) != @as(c_int, 0)) {
        samp.*.sample_length = samp.*.loop_end;
    }
    if (@as(c_int, @bitCast(@as(c_uint, samp.*.loop_type))) == @as(c_int, 2)) {
        Unroll_BIDI_Sample(samp);
    }
    if (samp.*.loop_type != 0) {
        if ((samp.*.loop_end -% samp.*.loop_start) < @as(@"u32", @bitCast(@as(c_int, 512)))) {
            Unroll_Sample_Loop(samp, (@as(@"u32", @bitCast(@as(c_int, 512))) / (samp.*.loop_end -% samp.*.loop_start)) +% @as(@"u32", @bitCast(@as(c_int, 1))));
        }
    }
}
pub export fn strcmpshit(arg_str1: [*c]u8, arg_str2: [*c]u8) c_int {
    var str1 = arg_str1;
    _ = &str1;
    var str2 = arg_str2;
    _ = &str2;
    ...
    while (@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = x;
        if (tmp >= 0) break :blk str1 + @as(usize, @intCast(tmp)) else break :blk str1 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) != @as(c_int, 0)) {
        if (@as(c_int, @bitCast(@as(c_uint, (blk: {
            ...
            const tmp = f;
            if (tmp >= 0) break :blk str2 + @as(usize, @intCast(tmp)) else break :blk str2 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*)))) {
            f += 1;
        } else {
            f = 0;
...
pub export fn FixSample_NDS(arg_samp: [*c]Sample) void {
    var samp = arg_samp;
    _ = &samp;
    ...
    if (samp.*.loop_type != 0) {
        if (!(ignore_sflags != 0)) {
            if (strcmpshit(@as([*c]u8, @ptrCast(@alignCast(&samp.*.name[@as(usize, @intCast(0))]))), @as([*c]u8, @ptrCast(@volatileCast(@constCast("%o"))))) > @as(c_int, 0)) {
                Unroll_Sample_Loop(samp, @as(@"u32", @bitCast(@as(c_int, 1))));
                samp.*.loop_start +%= (samp.*.loop_end -% samp.*.loop_start) / @as(@"u32", @bitCast(@as(c_int, 2)));
            }
        }
    }
    if (!(ignore_sflags != 0)) {
        if (strcmpshit(@as([*c]u8, @ptrCast(@alignCast(&samp.*.name[@as(usize, @intCast(0))]))), @as([*c]u8, @ptrCast(@volatileCast(@constCast("%c"))))) > @as(c_int, 0)) {
            samp.*.format |= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 4)))));
        }
    }
    if (samp.*.loop_type != 0) {
        var looplen: c_int = @as(c_int, @bitCast(samp.*.loop_end -% samp.*.loop_start));
        _ = &looplen;
        if (!((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 4)) != 0)) {
            if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
                if ((looplen & @as(c_int, 1)) != 0) {
                    var addition: c_int = @as(c_int, @bitCast(samp.*.loop_end -% samp.*.loop_start));
                    _ = &addition;
                    if (addition > @as(c_int, 1024)) {
                        Resample(samp, samp.*.sample_length +% @as(@"u32", @bitCast(@as(c_int, 1))));
                    } else {
                        Unroll_Sample_Loop(samp, @as(@"u32", @bitCast(@as(c_int, 1))));
                    }
                }
            } else {
                if ((looplen & @as(c_int, 3)) != 0) {
                    var count: c_int = undefined;
                    _ = &count;
                    var addition: c_int = undefined;
                    _ = &addition;
                    count = looplen & @as(c_int, 3);
                    while (true) {
                        switch (count) {
                            @as(c_int, 0) => {
                                count = 0;
                    ...
                    if (addition > @as(c_int, 1024)) {
                        Resample(samp, samp.*.sample_length +% @as(@"u32", @bitCast(@as(c_int, 4) - (looplen & @as(c_int, 3)))));
                    } else {
                        Unroll_Sample_Loop(samp, @as(@"u32", @bitCast(count)));
                    }
                }
            }
        } else {
            ...
            var addition: c_int = undefined;
            _ = &addition;
            while ((looplen & @as(c_int, 7)) != 0) {
                count += 1;
                looplen += a;
            }
            addition = looplen * count;
            if (addition > @as(c_int, 1024)) {
                Resample(samp, samp.*.sample_length +% @as(@"u32", @bitCast(@as(c_int, 4) - (looplen & @as(c_int, 7)))));
            } else {
                Unroll_Sample_Loop(samp, @as(@"u32", @bitCast(count)));
            }
        }
    ...
    if (samp.*.loop_type != 0) {
        var padsize: c_int = undefined;
        _ = &padsize;
        if (!((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 4)) != 0)) {
            if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
                padsize = @as(c_int, @bitCast((@as(@"u32", @bitCast(@as(c_int, 2))) -% (samp.*.loop_start & @as(@"u32", @bitCast(@as(c_int, 1))))) & @as(@"u32", @bitCast(@as(c_int, 1)))));
            } else {
                padsize = @as(c_int, @bitCast((@as(@"u32", @bitCast(@as(c_int, 4))) -% (samp.*.loop_start & @as(@"u32", @bitCast(@as(c_int, 3))))) & @as(@"u32", @bitCast(@as(c_int, 3)))));
            }
        } else {
            padsize = @as(c_int, @bitCast((@as(@"u32", @bitCast(@as(c_int, 8))) -% (samp.*.loop_start & @as(@"u32", @bitCast(@as(c_int, 7))))) & @as(@"u32", @bitCast(@as(c_int, 7)))));
        }
        Sample_PadStart(samp, @as(@"u32", @bitCast(padsize)));
    }
    if (!((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 4)) != 0)) {
        if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 1)) != 0) {
            if ((samp.*.sample_length & @as(@"u32", @bitCast(@as(c_int, 1)))) != 0) {
                Sample_PadEnd(samp, @as(@"u32", @bitCast(@as(c_int, 2))) -% (samp.*.sample_length & @as(@"u32", @bitCast(@as(c_int, 1)))));
            }
        } else {
            if ((samp.*.sample_length & @as(@"u32", @bitCast(@as(c_int, 3)))) != 0) {
                Sample_PadEnd(samp, @as(@"u32", @bitCast(@as(c_int, 4))) -% (samp.*.sample_length & @as(@"u32", @bitCast(@as(c_int, 3)))));
            }
        }
    } else {
        if ((samp.*.sample_length & @as(@"u32", @bitCast(@as(c_int, 7)))) != 0) {
            Sample_PadEnd(samp, @as(@"u32", @bitCast(@as(c_int, 8))) -% (samp.*.sample_length & @as(@"u32", @bitCast(@as(c_int, 7)))));
        }
    }
    Sample_Sign(samp);
    if ((@as(c_int, @bitCast(@as(c_uint, samp.*.format))) & @as(c_int, 4)) != 0) {
...
pub export fn MM_FixSampleImpl(arg_samp: [*c]Sample) void {
    var samp = arg_samp;
    _ = &samp;
    samp.*.loop_start = if (samp.*.loop_start < @as(@"u32", @bitCast(@as(c_int, 0)))) @as(@"u32", @bitCast(@as(c_int, 0))) else if (samp.*.loop_start > samp.*.sample_length) samp.*.sample_length else samp.*.loop_start;
    samp.*.loop_end = if (samp.*.loop_end < @as(@"u32", @bitCast(@as(c_int, 0)))) @as(@"u32", @bitCast(@as(c_int, 0))) else if (samp.*.loop_end > samp.*.sample_length) samp.*.sample_length else samp.*.loop_end;
    if (target_system == @as(c_int, 0)) {
        FixSample_GBA(samp);
    } else if (target_system == @as(c_int, 1)) {
        FixSample_NDS(samp);
    }
}
...
pub const FixSample = MM_FixSampleImpl;
pub const __GCC_HAVE_DWARF2_CFI_ASM = @as(c_int, 1);
pub const MAX_UNROLL_THRESHOLD = @as(c_int, 1024);
pub const GBA_MIN_LOOP_SIZE = @as(c_int, 512);
