...
pub export fn Load_S3M(arg_mod: [*c]MAS_Module, arg_verbose: @"bool") c_int {
    var mod = arg_mod;
    _ = &mod;
    var verbose = arg_verbose;
    _ = &verbose;
    var s3m_flags: @"u16" = undefined;
    _ = &s3m_flags;
    var cwt: @"u16" = undefined;
    _ = &cwt;
    var ffi: @"u16" = undefined;
    _ = &ffi;
    var dp: @"u8" = undefined;
    _ = &dp;
    var stereo: @"bool" = undefined;
    _ = &stereo;
    var a: @"u8" = undefined;
    _ = &a;
    var chan_enabled: [32]@"bool" = undefined;
    _ = &chan_enabled;
    var x: c_int = undefined;
    _ = &x;
    var y: c_int = undefined;
    _ = &y;
    var parap_inst: [*c]@"u16" = undefined;
    _ = &parap_inst;
    var parap_patt: [*c]@"u16" = undefined;
    _ = &parap_patt;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, read8()))) != @as(c_int, 26)) {}
    if (@as(c_int, @bitCast(@as(c_uint, read8()))) != @as(c_int, 16)) return 1;
    if (verbose != 0) {
        _ = printf("--------------------------------------------\n");
    }
    if (verbose != 0) {
        _ = printf("Loading S3M, \"%s\"\n", @as([*c]u8, @ptrCast(@alignCast(&mod.*.title[@as(usize, @intCast(0))]))));
    }
    ...
    cwt = read16();
    ffi = read16();
    if (read32() != @as(@"u32", @bitCast(@as(c_int, 1297236819)))) return 1;
    mod.*.global_volume = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, read8()))) * @as(c_int, 2)))));
    mod.*.initial_speed = read8();
    mod.*.initial_tempo = read8();
    stereo = @as(@"bool", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, read8()))) >> @intCast(7)))));
    _ = read8();
    dp = read8();
    skip8(@as(@"u32", @bitCast(@as(c_int, 8) + @as(c_int, 2))));
    {
        x = 0;
        while (x < @as(c_int, 32)) : (x += 1) {
            var chn: @"u8" = read8();
            _ = &chn;
            chan_enabled[@as(c_uint, @intCast(x))] = @as(@"bool", @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, chn))) >> @intCast(7)))));
            if (stereo != 0) {
                if ((@as(c_int, @bitCast(@as(c_uint, chn))) & @as(c_int, 127)) < @as(c_int, 8)) {
    ...
    parap_inst = @as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, mod.*.inst_count))) *% @sizeOf(@"u16")))));
    parap_patt = @as([*c]@"u16", @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, mod.*.patt_count))) *% @sizeOf(@"u16")))));
    {
        x = 0;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, dp))) == @as(c_int, 252)) {
        {
            x = 0;
            while (x < @as(c_int, 32)) : (x += 1) {
                a = read8();
                if ((@as(c_int, @bitCast(@as(c_uint, a))) & @as(c_int, 32)) != 0) {
                    mod.*.channel_panning[@as(c_uint, @intCast(x))] = @as(@"u8", @bitCast(@as(i8, @truncate(if (((@as(c_int, @bitCast(@as(c_uint, a))) & @as(c_int, 15)) * @as(c_int, 16)) > @as(c_int, 255)) @as(c_int, 255) else (@as(c_int, @bitCast(@as(c_uint, a))) & @as(c_int, 15)) * @as(c_int, 16)))));
                } else {}
            }
        }
    } else {
        {
            ...
            while (x < @as(c_int, 32)) : (x += 1) {
                if (stereo != 0) {
                    mod.*.channel_panning[@as(c_uint, @intCast(x))] = @as(@"u8", @bitCast(@as(i8, @truncate(if ((x & @as(c_int, 1)) != 0) clamp_u8(@as(c_int, 128) - @divTrunc(PANNING_SEP, @as(c_int, 2))) else clamp_u8(@as(c_int, 128) + @divTrunc(PANNING_SEP, @as(c_int, 2)))))));
                } else {
                    mod.*.channel_panning[@as(c_uint, @intCast(x))] = 128;
                }
            }
    ...
    mod.*.samples = @as([*c]Sample, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_ulong, mod.*.samp_count))) *% @sizeOf(Sample)))));
    ...
    }
    {
        ...
        while (x < @as(c_int, @bitCast(@as(c_uint, mod.*.inst_count)))) : (x += 1) {
            ...
            }).*)), @as(c_int, 0), @sizeOf(Instrument), __builtin_object_size(@as(?*const anyopaque, @ptrCast(&(blk: {
                const tmp = x;
                if (tmp >= 0) break :blk mod.*.instruments + @as(usize, @intCast(tmp)) else break :blk mod.*.instruments - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)), @as(c_int, 0)));
            (blk: {
            ...
            }).*.global_volume = 128;
            {
                ...
                while (y < @as(c_int, 120)) : (y += 1) {
                    (blk: {
                        const tmp = x;
                        if (tmp >= 0) break :blk mod.*.instruments + @as(usize, @intCast(tmp)) else break :blk mod.*.instruments - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.notemap[@as(c_uint, @intCast(y))] = @as(@"u16", @bitCast(@as(c_short, @truncate(y | ((x + @as(c_int, 1)) << @intCast(8))))));
                }
            }
            _ = file_seek_read(@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = x;
                if (tmp >= 0) break :blk parap_inst + @as(usize, @intCast(tmp)) else break :blk parap_inst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) * @as(c_int, 16), @as(c_int, 0));
            if (Load_S3M_Sample(&(blk: {
                const tmp = x;
                if (tmp >= 0) break :blk mod.*.samples + @as(usize, @intCast(tmp)) else break :blk mod.*.samples - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, verbose) != 0) {
                _ = printf("Error loading sample!\n");
                return 6;
            }
        }
    }
    ...
    }
    {
        ...
        while (x < @as(c_int, @bitCast(@as(c_uint, mod.*.samp_count)))) : (x += 1) {
            ...
            _ = Load_S3M_SampleData(&(blk: {
                const tmp = x;
                if (tmp >= 0) break :blk mod.*.samples + @as(usize, @intCast(tmp)) else break :blk mod.*.samples - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, @as(@"u8", @bitCast(@as(u8, @truncate(ffi)))));
        }
    }
    if (verbose != 0) {
        _ = printf("--------------------------------------------\n");
...
pub export fn Load_S3M_SampleData(arg_samp: [*c]Sample, arg_ffi: @"u8") c_int {
    var samp = arg_samp;
    _ = &samp;
    var ffi = arg_ffi;
    _ = &ffi;
...
pub export fn Load_S3M_Sample(arg_samp: [*c]Sample, arg_verbose: @"bool") c_int {
    var samp = arg_samp;
    _ = &samp;
    var verbose = arg_verbose;
    _ = &verbose;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, read8()))) == @as(c_int, 1)) {
        {
            x = 0;
            while (x < @as(@"u32", @bitCast(@as(c_int, 12)))) : (x +%= 1) {
                samp.*.filename[x] = @as(u8, @bitCast(read8()));
            }
        }
        samp.*.datapointer = @as(@"u32", @bitCast(((@as(c_int, @bitCast(@as(c_uint, read8()))) * @as(c_int, 65536)) + @as(c_int, @bitCast(@as(c_uint, read16())))) * @as(c_int, 16)));
        ...
        flags = read8();
        samp.*.loop_type = @as(@"u8", @bitCast(@as(i8, @truncate(if ((@as(c_int, @bitCast(@as(c_uint, flags))) & @as(c_int, 1)) != 0) @as(c_int, 1) else @as(c_int, 0)))));
        if ((@as(c_int, @bitCast(@as(c_uint, flags))) & @as(c_int, 2)) != 0) return 6;
        samp.*.format = @as(@"u8", @bitCast(@as(i8, @truncate(if ((@as(c_int, @bitCast(@as(c_uint, flags))) & @as(c_int, 4)) != 0) @as(c_int, 1) else @as(c_int, 0)))));
        samp.*.frequency = read32();
        _ = read32();
        skip8(@as(@"u32", @bitCast(@as(c_int, 8))));
        {
            x = 0;
            while (x < @as(@"u32", @bitCast(@as(c_int, 28)))) : (x +%= 1) {
                samp.*.name[x] = @as(u8, @bitCast(read8()));
            }
        }
        if (read32() != @as(@"u32", @bitCast(@as(c_int, 1397900115)))) return 6;
        if (verbose != 0) {
            _ = printf("%-5i   %-3s   %3i%%   %5ihz  %-28s \n", samp.*.sample_length, if (@as(c_int, @bitCast(@as(c_uint, samp.*.loop_type))) != 0) "Yes" else "No", @divTrunc(@as(c_int, @bitCast(@as(c_uint, samp.*.default_volume))) * @as(c_int, 100), @as(c_int, 64)), samp.*.frequency, @as([*c]u8, @ptrCast(@alignCast(&samp.*.name[@as(usize, @intCast(0))]))));
        }
    } else {
        if (verbose != 0) {
            _ = printf("-----   ---   ----   -------  %-28s\n", @as([*c]u8, @ptrCast(@alignCast(&samp.*.name[@as(usize, @intCast(0))]))));
        }
    }
    return 0;
}
pub export fn Load_S3M_Pattern(arg_patt: [*c]Pattern) c_int {
    var patt = arg_patt;
    _ = &patt;
    var clength: c_int = undefined;
    _ = &clength;
    var row: c_int = undefined;
    _ = &row;
    var col: c_int = undefined;
    _ = &col;
    var what: @"u8" = undefined;
    _ = &what;
    var z: c_int = undefined;
    _ = &z;
    clength = @as(c_int, @bitCast(@as(c_uint, read16())));
    ...
    {
        row = 0;
        while (row < (@as(c_int, 64) * @as(c_int, 32))) : (row += 1) {
            patt.*.data[@as(c_uint, @intCast(row))].note = 250;
            patt.*.data[@as(c_uint, @intCast(row))].vol = 255;
        }
    }
    {
        row = 0;
        while (row < @as(c_int, 64)) : (row += 1) {
            while (@as(c_int, @bitCast(@as(c_uint, blk: {
                const tmp = read8();
                what = tmp;
                break :blk tmp;
            }))) != @as(c_int, 0)) {
                col = @as(c_int, @bitCast(@as(c_uint, what))) & @as(c_int, 31);
                z = (row * @as(c_int, 32)) + col;
                if ((@as(c_int, @bitCast(@as(c_uint, what))) & @as(c_int, 32)) != 0) {
                    patt.*.data[@as(c_uint, @intCast(z))].note = read8();
                    if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].note))) == @as(c_int, 255)) {
                        patt.*.data[@as(c_uint, @intCast(z))].note = 250;
                    } else if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].note))) == @as(c_int, 254)) {
                        patt.*.data[@as(c_uint, @intCast(z))].note = 254;
                    } else {
                        patt.*.data[@as(c_uint, @intCast(z))].note = @as(@"u8", @bitCast(@as(i8, @truncate(((@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].note))) & @as(c_int, 15)) + ((@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].note))) >> @intCast(4)) * @as(c_int, 12))) + @as(c_int, 12)))));
                    }
                    patt.*.data[@as(c_uint, @intCast(z))].inst = read8();
                }
                if ((@as(c_int, @bitCast(@as(c_uint, what))) & @as(c_int, 64)) != 0) {
                    patt.*.data[@as(c_uint, @intCast(z))].vol = read8();
                }
                if ((@as(c_int, @bitCast(@as(c_uint, what))) & @as(c_int, 128)) != 0) {
                    patt.*.data[@as(c_uint, @intCast(z))].fx = read8();
                    patt.*.data[@as(c_uint, @intCast(z))].param = read8();
                    if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].fx))) == @as(c_int, 3)) {
                        patt.*.data[@as(c_uint, @intCast(z))].param = @as(@"u8", @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].param))) & @as(c_int, 15)) + (@divTrunc(@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].param))), @as(c_int, 16)) * @as(c_int, 10))))));
                    }
                    if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].fx))) == (@as(c_int, 'X') - @as(c_int, 64))) {
                        patt.*.data[@as(c_uint, @intCast(z))].param *%= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 2)))));
                    }
                    if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].fx))) == (@as(c_int, 'V') - @as(c_int, 64))) {
                        patt.*.data[@as(c_uint, @intCast(z))].param *%= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 2)))));
                    }
                }
                if (@as(c_int, @bitCast(@as(c_uint, patt.*.data[@as(c_uint, @intCast(z))].fx))) == @as(c_int, 255)) {
                    patt.*.data[@as(c_uint, @intCast(z))].fx = 0;
                    patt.*.data[@as(c_uint, @intCast(z))].param = 0;
                }
            }
        }
    }
...
pub inline fn S3M_NOTE(a: anytype) @TypeOf(((a & @as(c_int, 15)) + ((a >> @as(c_int, 4)) * @as(c_int, 12))) + @as(c_int, 12)) {
    _ = &a;
    return ((a & @as(c_int, 15)) + ((a >> @as(c_int, 4)) * @as(c_int, 12))) + @as(c_int, 12);
}
pub const vstr_s3m_samp = "%-5i   %-3s   %3i%%   %5ihz  %-28s \n";
pub const vstr_s3m_sampe = "-----   ---   ----   -------  %-28s\n";
pub const vstr_s3m_div = "--------------------------------------------\n";
pub const vstr_s3m_sampt_top = vstr_s3m_div;
pub const vstr_s3m_sampt_mid = " INDEX LENGTH  LOOP  VOLUME  MID-C   NAME\n";
pub const vstr_s3m_sampt_index = " %-2i    ";
pub const vstr_s3m_sampt_bottom = vstr_s3m_div;
pub const vstr_s3m_pattern = " * %2i%s";
